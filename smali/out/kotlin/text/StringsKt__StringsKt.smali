...
.method public static final synthetic access$findAnyOf(Ljava/lang/CharSequence;Ljava/util/Collection;IZZ)Lkotlin/Pair;
    .registers 6
    .param p0, "$this$access_u24findAnyOf"    # Ljava/lang/CharSequence;
...
.method private static final findAnyOf$StringsKt__StringsKt(Ljava/lang/CharSequence;Ljava/util/Collection;IZZ)Lkotlin/Pair;
    ...
    if-gt v0, v10, :cond_10d

    goto :goto_6f

    :cond_6d
    if-lt v0, v10, :cond_10d
...
.method private static final rangesDelimitedBy$StringsKt__StringsKt(Ljava/lang/CharSequence;[CIZI)Lkotlin/sequences/Sequence;
    ...
    .local v0, "$i$a$-require-StringsKt__StringsKt$rangesDelimitedBy$1":I
    new-instance v1, Ljava/lang/StringBuilder;
    ...
    .end local v0    # "$i$a$-require-StringsKt__StringsKt$rangesDelimitedBy$1":I
...
.method private static final rangesDelimitedBy$StringsKt__StringsKt(Ljava/lang/CharSequence;[Ljava/lang/String;IZI)Lkotlin/sequences/Sequence;
    ...
    invoke-direct {v2, v0, p3}, Lkotlin/text/StringsKt__StringsKt$rangesDelimitedBy$4;-><init>(Ljava/util/List;Z)V
    ...
    .line 1167
    .end local v0    # "delimitersList":Ljava/util/List;
    :cond_1a
    const/4 v0, 0x0

    .local v0, "$i$a$-require-StringsKt__StringsKt$rangesDelimitedBy$3":I
    new-instance v1, Ljava/lang/StringBuilder;
    ...
    .end local v0    # "$i$a$-require-StringsKt__StringsKt$rangesDelimitedBy$3":I
    new-instance v1, Ljava/lang/IllegalArgumentException;
...
.method public static final removeRange(Ljava/lang/CharSequence;II)Ljava/lang/CharSequence;
    ...
    invoke-virtual {v1, p0, p2, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/CharSequence;II)Ljava/lang/StringBuilder;
...
.method private static final removeRange(Ljava/lang/String;II)Ljava/lang/String;
    ...
    invoke-static {v1, p1, p2}, Lkotlin/text/StringsKt;->removeRange(Ljava/lang/CharSequence;II)Ljava/lang/CharSequence;
...
.method private static final removeRange(Ljava/lang/String;Lkotlin/ranges/IntRange;)Ljava/lang/String;
    ...
    invoke-static {v1, p1}, Lkotlin/text/StringsKt;->removeRange(Ljava/lang/CharSequence;Lkotlin/ranges/IntRange;)Ljava/lang/CharSequence;
...
.method public static final replaceBefore(Ljava/lang/String;CLjava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v2, v1, v0, v3}, Lkotlin/text/StringsKt;->replaceRange(Ljava/lang/CharSequence;IILjava/lang/CharSequence;)Ljava/lang/CharSequence;
...
.method private static final replaceRange(Ljava/lang/String;IILjava/lang/CharSequence;)Ljava/lang/String;
    ...
    invoke-static {v1, p1, p2, p3}, Lkotlin/text/StringsKt;->replaceRange(Ljava/lang/CharSequence;IILjava/lang/CharSequence;)Ljava/lang/CharSequence;
...
.method private static final replaceRange(Ljava/lang/String;Lkotlin/ranges/IntRange;Ljava/lang/CharSequence;)Ljava/lang/String;
    ...
    invoke-static {v1, p1, p2}, Lkotlin/text/StringsKt;->replaceRange(Ljava/lang/CharSequence;Lkotlin/ranges/IntRange;Ljava/lang/CharSequence;)Ljava/lang/CharSequence;
...
.method private static final split$StringsKt__StringsKt(Ljava/lang/CharSequence;Ljava/lang/String;ZI)Ljava/util/List;
    ...
    invoke-static {p0, p1, v2, p2}, Lkotlin/text/StringsKt;->indexOf(Ljava/lang/CharSequence;Ljava/lang/String;IZ)I
    ...
    .local v0, "$i$a$-require-StringsKt__StringsKt$split$3":I
    new-instance v1, Ljava/lang/StringBuilder;
    ...
    .end local v0    # "$i$a$-require-StringsKt__StringsKt$split$3":I
    new-instance v1, Ljava/lang/IllegalArgumentException;
...
.method public static final trim(Ljava/lang/CharSequence;)Ljava/lang/CharSequence;
    ...
    .line 114
    .local v7, "$i$a$-unknown-StringsKt__StringsKt$trim$3":I
    invoke-static {v6}, Lkotlin/text/CharsKt;->isWhitespace(C)Z

    move-result v6

    .line 1399
    .end local v7    # "$i$a$-unknown-StringsKt__StringsKt$trim$3":I
    .local v6, "match$iv":Z
    if-nez v4, :cond_28
...
.method public static final trimEnd(Ljava/lang/CharSequence;)Ljava/lang/CharSequence;
    ...
    .line 136
    .local v4, "$i$a$-unknown-StringsKt__StringsKt$trimEnd$3":I
    invoke-static {v3}, Lkotlin/text/CharsKt;->isWhitespace(C)Z

    move-result v3

    .end local v3    # "p1":C
    .end local v4    # "$i$a$-unknown-StringsKt__StringsKt$trimEnd$3":I
    if-nez v3, :cond_22
...
.method public static final varargs trimEnd(Ljava/lang/CharSequence;[C)Ljava/lang/CharSequence;
    ...
    .line 104
    .local v4, "$i$a$-trimEnd-StringsKt__StringsKt$trimEnd$1":I
    invoke-static {p1, v3}, Lkotlin/collections/ArraysKt;->contains([CC)Z

    move-result v3

    .end local v3    # "it":C
    .end local v4    # "$i$a$-trimEnd-StringsKt__StringsKt$trimEnd$1":I
    if-nez v3, :cond_27
...
.method public static final varargs trimEnd(Ljava/lang/String;[C)Ljava/lang/String;
    ...
    .line 109
    .local v6, "$i$a$-trimEnd-StringsKt__StringsKt$trimEnd$2":I
    invoke-static {p1, v5}, Lkotlin/collections/ArraysKt;->contains([CC)Z

    move-result v5

    .end local v5    # "it":C
    .end local v6    # "$i$a$-trimEnd-StringsKt__StringsKt$trimEnd$2":I
    if-nez v5, :cond_2b
...
.method public static final trimStart(Ljava/lang/CharSequence;)Ljava/lang/CharSequence;
    ...
    .line 125
    .local v5, "$i$a$-unknown-StringsKt__StringsKt$trimStart$3":I
    invoke-static {v4}, Lkotlin/text/CharsKt;->isWhitespace(C)Z

    move-result v4

    .end local v4    # "p1":C
    .end local v5    # "$i$a$-unknown-StringsKt__StringsKt$trimStart$3":I
    if-nez v4, :cond_22
...
.method public static final trimStart(Ljava/lang/CharSequence;Lkotlin/jvm/functions/Function1;)Ljava/lang/CharSequence;
    ...
    const-string v1, "$this$trimStart"
