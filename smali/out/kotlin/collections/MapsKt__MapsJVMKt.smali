...
.method private static final checkBuilderCapacity(I)V
    .registers 2
    .param p0, "capacity"    # I
    ...
    .line 123
    .local v0, "$i$f$checkBuilderCapacity":I
    return-void
.end method
...
.method public static final getOrPut(Ljava/util/concurrent/ConcurrentMap;Ljava/lang/Object;Lkotlin/jvm/functions/Function0;)Ljava/lang/Object;
    .registers 7
    .param p0, "$this$getOrPut"    # Ljava/util/concurrent/ConcurrentMap;
    ...
    .local v2, "$i$a$-let-MapsKt__MapsJVMKt$getOrPut$1":I
    ...
    .end local v2    # "$i$a$-let-MapsKt__MapsJVMKt$getOrPut$1":I
    :cond_1e
    :goto_1e
    return-object v1
.end method
...
.method public static final varargs sortedMapOf([Lkotlin/Pair;)Ljava/util/SortedMap;
    ...
    .local v1, "$this$apply":Ljava/util/TreeMap;
    const/4 v2, 0x0

    .local v2, "$i$a$-apply-MapsKt__MapsJVMKt$sortedMapOf$1":I
    move-object v3, v1
    ...
    .end local v1    # "$this$apply":Ljava/util/TreeMap;
...
.method private static final toProperties(Ljava/util/Map;)Ljava/util/Properties;
    .registers 5
    .param p0, "$this$toProperties"    # Ljava/util/Map;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
            "Ljava/util/Map<",
    ...
    .local v2, "$this$apply":Ljava/util/Properties;
    const/4 v3, 0x0

    .local v3, "$i$a$-apply-MapsKt__MapsJVMKt$toProperties$1":I
    invoke-virtual {v2, p0}, Ljava/util/Properties;->putAll(Ljava/util/Map;)V

    .end local v2    # "$this$apply":Ljava/util/Properties;
    .end local v3    # "$i$a$-apply-MapsKt__MapsJVMKt$toProperties$1":I
    return-object v1
.end method
...
.method public static final toSingletonMap(Ljava/util/Map;)Ljava/util/Map;
    ...
    const-string v3, "java.util.Collections.singletonMap(key, value)"
...
.method private static final toSingletonMapOrSelf(Ljava/util/Map;)Ljava/util/Map;
    .registers 3
    .param p0, "$this$toSingletonMapOrSelf"    # Ljava/util/Map;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<K:",
            "Ljava/lang/Object;",
    ...
    .line 92
    .local v0, "$i$f$toSingletonMapOrSelf":I
...
.method public static final toSortedMap(Ljava/util/Map;)Ljava/util/SortedMap;
    .registers 2
    .param p0, "$this$toSortedMap"    # Ljava/util/Map;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<K::",
            "Ljava/lang/Comparable<",
