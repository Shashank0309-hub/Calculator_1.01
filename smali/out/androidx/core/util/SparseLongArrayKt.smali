...
.method public static final contains(Landroid/util/SparseLongArray;I)Z
    .registers 4
    .param p0, "$this$contains"    # Landroid/util/SparseLongArray;
    .param p1, "key"    # I
...
.method public static final containsKey(Landroid/util/SparseLongArray;I)Z
    .registers 4
    .param p0, "$this$containsKey"    # Landroid/util/SparseLongArray;
    .param p1, "key"    # I
...
.method public static final containsValue(Landroid/util/SparseLongArray;J)Z
    .registers 5
    .param p0, "$this$containsValue"    # Landroid/util/SparseLongArray;
    .param p1, "value"    # J
...
.method public static final forEach(Landroid/util/SparseLongArray;Lkotlin/jvm/functions/Function2;)V
    .registers 8
    .param p0, "$this$forEach"    # Landroid/util/SparseLongArray;
...
.method public static final getOrDefault(Landroid/util/SparseLongArray;IJ)J
    .registers 7
    .param p0, "$this$getOrDefault"    # Landroid/util/SparseLongArray;
    .param p1, "key"    # I
...
.method public static final getOrElse(Landroid/util/SparseLongArray;ILkotlin/jvm/functions/Function0;)J
    .registers 8
    .param p0, "$this$getOrElse"    # Landroid/util/SparseLongArray;
    .param p1, "key"    # I
    ...
    .local v2, "$i$a$-let-SparseLongArrayKt$getOrElse$1":I
    if-ltz v1, :cond_17
    ...
    .end local v1    # "it":I
    .end local v2    # "$i$a$-let-SparseLongArrayKt$getOrElse$1":I
    :goto_21
    return-wide v3
.end method
...
.method public static final getSize(Landroid/util/SparseLongArray;)I
    .registers 3
    .param p0, "$this$size"    # Landroid/util/SparseLongArray;
...
.method public static final isEmpty(Landroid/util/SparseLongArray;)Z
    .registers 3
    .param p0, "$this$isEmpty"    # Landroid/util/SparseLongArray;
...
.method public static final isNotEmpty(Landroid/util/SparseLongArray;)Z
    .registers 3
    .param p0, "$this$isNotEmpty"    # Landroid/util/SparseLongArray;
...
.method public static final keyIterator(Landroid/util/SparseLongArray;)Lkotlin/collections/IntIterator;
    .registers 2
    .param p0, "$this$keyIterator"    # Landroid/util/SparseLongArray;
...
.method public static final plus(Landroid/util/SparseLongArray;Landroid/util/SparseLongArray;)Landroid/util/SparseLongArray;
    .registers 5
    .param p0, "$this$plus"    # Landroid/util/SparseLongArray;
    .param p1, "other"    # Landroid/util/SparseLongArray;
    ...
    .line 40
    .local v0, "new":Landroid/util/SparseLongArray;
...
.method public static final putAll(Landroid/util/SparseLongArray;Landroid/util/SparseLongArray;)V
    .registers 10
    .param p0, "$this$putAll"    # Landroid/util/SparseLongArray;
    .param p1, "other"    # Landroid/util/SparseLongArray;
    ...
    .local v0, "$this$forEach$iv":Landroid/util/SparseLongArray;
    const/4 v1, 0x0
    ...
    .line 110
    .local v3, "index$iv":I
    invoke-virtual {v0, v3}, Landroid/util/SparseLongArray;->keyAt(I)I

    move-result v4

    .local v4, "p1":I
    invoke-virtual {v0, v3}, Landroid/util/SparseLongArray;->valueAt(I)J
    ...
    .line 83
    .local v7, "$i$a$-unknown-SparseLongArrayKt$putAll$1":I
    invoke-virtual {p0, v4, v5, v6}, Landroid/util/SparseLongArray;->put(IJ)V

    .line 109
    .end local v4    # "p1":I
    .end local v5    # "p2":J
    .end local v7    # "$i$a$-unknown-SparseLongArrayKt$putAll$1":I
    nop
    ...
    .line 83
    .end local v0    # "$this$forEach$iv":Landroid/util/SparseLongArray;
...
.method public static final remove(Landroid/util/SparseLongArray;IJ)Z
    .registers 7
    .param p0, "$this$remove"    # Landroid/util/SparseLongArray;
    .param p1, "key"    # I
    .param p2, "value"    # J
...
.method public static final set(Landroid/util/SparseLongArray;IJ)V
    .registers 6
    .param p0, "$this$set"    # Landroid/util/SparseLongArray;
    .param p1, "key"    # I
    .param p2, "value"    # J
...
.method public static final valueIterator(Landroid/util/SparseLongArray;)Lkotlin/collections/LongIterator;
    .registers 2
    .param p0, "$this$valueIterator"    # Landroid/util/SparseLongArray;
