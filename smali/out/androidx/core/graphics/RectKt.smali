...
.method public static final and(Landroid/graphics/Rect;Landroid/graphics/Rect;)Landroid/graphics/Rect;
    ...
    .local v2, "$this$apply":Landroid/graphics/Rect;
    const/4 v3, 0x0
    ...
    .line 284
    .end local v2    # "$this$apply":Landroid/graphics/Rect;
...
.method public static final minus(Landroid/graphics/RectF;Landroid/graphics/RectF;)Landroid/graphics/Region;
    ...
    .local v1, "$this$toRect$iv":Landroid/graphics/RectF;
    const/4 v2, 0x0

    .line 366
    .local v2, "$i$f$toRect":I
    new-instance v3, Landroid/graphics/Rect;

    invoke-direct {v3}, Landroid/graphics/Rect;-><init>()V

    .line 367
    .local v3, "r$iv":Landroid/graphics/Rect;
    ...
    .line 191
    .end local v1    # "$this$toRect$iv":Landroid/graphics/RectF;
    .end local v2    # "$i$f$toRect":I
    .end local v3    # "r$iv":Landroid/graphics/Rect;
    new-instance v1, Landroid/graphics/Region;

    invoke-direct {v1, v3}, Landroid/graphics/Region;-><init>(Landroid/graphics/Rect;)V
...
.method public static final or(Landroid/graphics/Rect;Landroid/graphics/Rect;)Landroid/graphics/Rect;
    ...
    .local v4, "$this$apply$iv":Landroid/graphics/Rect;
    const/4 v5, 0x0
    ...
    .line 380
    .end local v4    # "$this$apply$iv":Landroid/graphics/Rect;
...
.method public static final or(Landroid/graphics/RectF;Landroid/graphics/RectF;)Landroid/graphics/RectF;
    ...
    .local v4, "$this$apply$iv":Landroid/graphics/RectF;
    const/4 v5, 0x0
    ...
    .line 383
    .end local v4    # "$this$apply$iv":Landroid/graphics/RectF;
...
.method public static final times(Landroid/graphics/RectF;I)Landroid/graphics/RectF;
    ...
    .local v5, "$this$apply$iv":Landroid/graphics/RectF;
    const/4 v6, 0x0
    ...
    .line 377
    .end local v5    # "$this$apply$iv":Landroid/graphics/RectF;
