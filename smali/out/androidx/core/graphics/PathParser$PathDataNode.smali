...
.method private static addCommand(Landroid/graphics/Path;[FCC[F)V
    ...
    sparse-switch v11, :sswitch_data_406
    ...
    if-eq v11, v0, :cond_3a4

    const/16 v0, 0x43

    if-eq v11, v0, :cond_36c

    const/16 v2, 0x48

    if-eq v11, v2, :cond_35a

    const/16 v2, 0x51

    if-eq v11, v2, :cond_32b

    const/16 v3, 0x56

    if-eq v11, v3, :cond_319

    const/16 v3, 0x61

    if-eq v11, v3, :cond_2c6

    const/16 v3, 0x63

    if-eq v11, v3, :cond_28a

    const/16 v4, 0x68

    if-eq v11, v4, :cond_279

    const/16 v4, 0x71

    if-eq v11, v4, :cond_247

    const/16 v5, 0x76

    if-eq v11, v5, :cond_235
    ...
    if-eq v11, v5, :cond_19e

    const/16 v15, 0x74

    const/16 v14, 0x54

    if-eq v11, v14, :cond_16b
    ...
    if-eq v11, v13, :cond_11e

    if-eq v11, v1, :cond_d1
    ...
    if-eq v9, v15, :cond_ac

    if-eq v9, v2, :cond_ac

    if-ne v9, v14, :cond_b0
    ...
    .line 545
    .local v4, "reflectiveCtrlPointY":F
    if-eq v9, v3, :cond_1ad

    if-eq v9, v1, :cond_1ad

    if-eq v9, v0, :cond_1ad

    if-ne v9, v5, :cond_1aa
